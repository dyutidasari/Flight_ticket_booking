...
exports.getticketbookingdata = async (req, res) => {
    ...
    if(!users) {
        ...
        flightdetails = await sequelize.query(
            ...
            `select dept_airport,arrival_airport,total_tickets,availble_tickets,fare from flight_table where flight_id = ${req.body.flight_id} ;`,
